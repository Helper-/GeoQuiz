...
public class CheatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiLevel.setText((String) "API Level " + Build.VERSION.SDK_INT);
        ...
        if(savedInstanceState != null) {
            ...
            mAnswerTextView.setText(savedInstanceState.getString(ANSWER_SHOWN));
        }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putString(ANSWER_SHOWN, (mAnswerTextView.getText().toString()));
    }
}
